...
export default function FloatingContact() {
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3">
      ...
      >
        <span className="rounded-full bg-cosmos/90 px-3 py-1.5 text-xs text-parchment shadow-lg">
          Chat on WhatsApp
        </span>
        <span className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/40 transition-transform group-hover:scale-110">
      ...
      >
        ...
        <span className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-[#229ED9] shadow-lg shadow-black/40 transition-transform group-hover:scale-110">
          <svg viewBox="0 0 32 32" className="h-7 w-7" fill="white">
